---
title: "Prefabricated Modular Expandable Container House"
menu:
  main:
    parent: "other"
    identifier: "prefabricated-modular-expandable-container-house"
    name: "Prefabricated Modular Expandable Container House"
    url: "/other/prefabricated-modular-expandable-container-house/"
    weight: 1
date: 2025-05-04
...
<div style="display: flex; align-items: center; justify-content: space-between; background-color: rgb(1, 136, 255); border: 1px solid #cce; border-radius: 12px; padding: 1rem 1.5rem; max-width: 500px; margin: 1rem 0; box-shadow: 0 2px 8px rgba(0,0,0,0.05);">
  <div style="font-size: 1.1rem; color: #fff;">
    📄 <strong> Double-wing Expansion House</strong><br/>
    PDF Download Available
  </div>
  <a href="/xcmobile/files/Double-wing Expansion House.pdf" target="_blank" style="background-color: #ffffff; color: #007BFF; padding: 0.6rem 1rem; border-radius: 6px; text-decoration: none; font-weight: bold; white-space: nowrap; margin-left: 1rem;">
    View PDF
  </a>
</div>    
...
<table style="border: 1px solid #ddd; border-collapse: collapse;">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="border: 1px solid #ddd; padding: 8px;">11.8m (L) * 2.2m (W) * 2.48m (H) or 2.9m (H)</td>
    </tr>
    <tr>
...
##  <center>Other layout can be customized, please contact me for helping
